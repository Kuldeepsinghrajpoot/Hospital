                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <form id="formAuthentication" className="mb-3" onSubmit={handleSubmit} >
                                    ...
                                    <button
                                        className=" btn btn-primary  w-100bg-[#7367F0] hover:bg-[#7b70fa] text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded w-full"
                                        type="submit"
